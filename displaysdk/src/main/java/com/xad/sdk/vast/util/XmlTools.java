...
public class XmlTools {
    ...
    public static void logXmlDocument(Document doc) {
        Logger.logDebug(TAG, "logXmlDocument");
        try {
            ...
            Logger.logDebug(TAG, sw.toString());
    ...
    public static String xmlDocumentToString(Document doc) {
        String xml = null;
        Logger.logDebug(TAG, "xmlDocumentToString");
        try {
            TransformerFactory tf = TransformerFactory.newInstance();
            Transformer transformer = tf.newTransformer();
            transformer
    ...
    public static Document stringToDocument(String doc) {
        Logger.logDebug(TAG, "stringToDocument");
    ...
    public static String stringFromStream(InputStream inputStream)
            throws IOException {
        Logger.logDebug(TAG, "stringFromStream");
    ...
    public static String getElementValue(Node node) {
        ...
        for (int childIndex = 0; childIndex < childNodes.getLength(); childIndex++) {
            ...
            Logger.logVerbose(TAG, "getElementValue: " + value);
            return value;
