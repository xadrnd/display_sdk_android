...
public class CustomEventForDFP implements BannerViewListener, InterstitialAdListener, CustomEventBanner, CustomEventInterstitial {

    private static final String TAG = "CustomEventForDFP";
